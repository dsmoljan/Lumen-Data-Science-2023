...
class classifierModel(object):
    def __init__(self, args):
        ...
        try:
            ...
            self.best_micro_f1 = ckpt['best_micro_f1']
        except Exception as e:
            print(' [*] No checkpoint!')
            self.start_epoch = 0
            self.best_micro_f1 = -100
    ...
    def train(self):
        ...
        val_set = IRMASDataset(self.args.data_root_path, DATA_MEAN, DATA_STD, n_mels=256, name='val', audio_augmentation=True, spectogram_augmentation=True, sr=44100, return_type='image')
    ...
    def eval(self, epoch, val_loader):
        ...
        with torch.no_grad():
            ...
            if (result['micro/f1'] > self.best_micro_f1):
                torch.save({'epoch': epoch + 1,
                            'model_state': self.model.state_dict(),
                            'model_optimizer': self.optimizer.state_dict(),
                            'best_micro_f1': self.best_micro_f1},
